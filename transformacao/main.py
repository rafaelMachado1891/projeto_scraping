...
# leitura do meu arquivo jsonl usando jsonlines
data = []
with jsonlines.open('../dados/dados.jsonl') as reader:
    for obj in reader:
        data.append(obj)

# criar DataFrame com os dados lidos
...
# adicionar a coluna id se necessário
